...
document.getElementById('formularioPesquisa').addEventListener('submit', function(e) {
    ...
    var dadosDoFormulario = {
        ...
        porqueRejeicaoVoto: document.getElementById('porqueRejeicaoVoto').value,
        quemGanhaEleicao: document.getElementById('quemGanhaEleicao').value,
        mudariaVoto: document.getElementById('mudariaVoto').value,
        mudouVoto: document.getElementById('mudouVoto').value,
    ...
    document.getElementById('porqueRejeicaoVoto').value = '';
    document.getElementById('quemGanhaEleicao').value = '';
    document.getElementById('mudariaVoto').value = '';
    document.getElementById('mudouVoto').value = '';
